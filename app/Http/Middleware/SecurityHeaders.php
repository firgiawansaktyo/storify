...
class SecurityHeaders
{
    public function handle(Request $request, Closure $next)
    {
        ...
        if (env('APP_ENV') === 'local') {
            ...
            $csp = "default-src 'self'; "
                . "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://sweetvows.site https://cdn.sweetvows.site; "
                ...
                . "connect-src 'self' https://sweetvows.site https://cdn.sweetvows.site https://*.backblazeb2.com; "
                . "frame-src 'self' https://www.google.com https://*.google.com; "
                . "child-src 'self' https://www.google.com https://*.google.com; "
                . "frame-ancestors 'none'; "
                . "form-action 'self'; "

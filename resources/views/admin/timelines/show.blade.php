    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <img    
          ...
          src="{{ old('wedding_vow_image') ? cdn_sweetvows(old('wedding_vow_image')) : (isset($timeline) && $timeline->wedding_vow_image ? cdn_sweetvows($timeline->wedding_vow_image) : '') }}">
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
              <div class="modal-content">
                  @if($timeline->wedding_vow_image)
                    <img src="{{ cdn_sweetvows($timeline->wedding_vow_image) }}" alt="Full Image">
                  @endif
              </div>
          </div>
        </div>
      ...
      <div class="form-group">
        ...
        <img    
          ...
          src="{{ old('wedding_reception_image') ? cdn_sweetvows(old('wedding_reception_image')) : (isset($timeline) && $timeline->wedding_reception_image ? cdn_sweetvows($timeline->wedding_reception_image) : '') }}">
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
              <div class="modal-content">
                  @if($timeline->wedding_reception_image)
                    <img src="{{ cdn_sweetvows($timeline->wedding_reception_image) }}" alt="Full Image">
                  @endif
              </div>
          </div>
        </div>

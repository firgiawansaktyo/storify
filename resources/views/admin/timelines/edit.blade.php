  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="date" id="wedding_vow_date" class="form-control" value="{{ old('wedding_vow_date' , $timeline->wedding_vow_date) }}" required>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Vow Start Time</label>
        <input type="time" id="wedding_vow_start_time" class="form-control" value="{{ old('wedding_vow_start_time', $timeline->wedding_vow_start_time) }}" required>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Vow End Time</label>
        <input type="time" id="wedding_vow_end_time" class="form-control" value="{{ old('wedding_vow_end_time', $timeline->wedding_vow_end_time) }}" required>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Vow Location</label>
        <textarea style="height: 100px;" type="text" id="wedding_vow_location" class="form-control" value="{{ old('wedding_vow_location', $timeline->wedding_vow_location) }}" required>{{ old('wedding_vow_location', $timeline->wedding_vow_location) }}</textarea>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Vow Address</label>
        <textarea style="height: 100px;" type="text" id="wedding_vow_address" class="form-control" value="{{ old('wedding_vow_address', $timeline->wedding_vow_address) }}" required>{{ old('wedding_vow_address', $timeline->wedding_vow_address) }}</textarea>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Vow Location Link</label>
        <textarea style="height: 100px;" type="text" id="wedding_vow_location_link" class="form-control" value="{{ old('wedding_vow_location_link', $timeline->wedding_vow_location_link) }}" required>{{ old('wedding_vow_location_link', $timeline->wedding_vow_location_link) }}</textarea>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Vow Iframe</label>
        <textarea style="height: 100px;" type="text" id="wedding_vow_iframe" class="form-control" value="{{ old('wedding_vow_iframe', $timeline->wedding_vow_iframe) }}" required>{{ old('wedding_vow_iframe', $timeline->wedding_vow_iframe) }}</textarea>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Reception Date</label>
        <input type="date" id="wedding_reception_date" class="form-control" value="{{ old('wedding_reception_date', $timeline->wedding_reception_date) }}" required>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Reception Start Time</label>
        <input type="time" id="wedding_reception_start_time" class="form-control" value="{{ old('wedding_reception_start_time', $timeline->wedding_reception_start_time) }}" required>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Reception End Time</label>
        <input type="time" id="wedding_reception_end_time" class="form-control" value="{{ old('wedding_reception_end_time', $timeline->wedding_reception_end_time) }}" required>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Reception Location</label>
        <textarea style="height: 100px;" type="text" id="wedding_reception_location" class="form-control" value="{{ old('wedding_reception_location', $timeline->wedding_reception_location) }}" required>{{ old('wedding_reception_location', $timeline->wedding_reception_location) }}</textarea>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Reception Address</label>
        <textarea style="height: 100px;" type="text" id="wedding_reception_address" class="form-control" value="{{ old('wedding_reception_address', $timeline->wedding_reception_address) }}" required>{{ old('wedding_reception_address', $timeline->wedding_reception_address) }}</textarea>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Reception Location Link</label>
        <textarea style="height: 100px;" type="text" id="wedding_reception_location_link" class="form-control" value="{{ old('wedding_reception_location_link', $timeline->wedding_reception_location_link) }}" required>{{ old('wedding_reception_location_link', $timeline->wedding_reception_location_link) }}</textarea>
      </div>
      <div class="form-group">
        <label class="text-white">Wedding Reception Iframe</label>
        <textarea style="height: 100px;" type="text" id="wedding_reception_iframe" class="form-control" value="{{ old('wedding_reception_iframe', $timeline->wedding_reception_iframe) }}" required>{{ old('wedding_reception_iframe', $timeline->wedding_reception_iframe) }}</textarea>
      </div>
...
document.getElementById('saveButton').addEventListener('click', function() {
    ...
    // Post to Laravel
    axios.put('{{ route('timelines.update', $timeline->id) }}', timelineData)

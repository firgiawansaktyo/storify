    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <img
          ...
          src="{{ old('wedding_vow_image') ? asset('storage/' . old('wedding_vow_image')) : ($timeline->wedding_vow_image ? asset('storage/' . $timeline->wedding_vow_image) : '') }}"
          alt="Vow Image"
        >
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              @if($timeline->wedding_vow_image)
                <img src="{{ asset('storage/' . $timeline->wedding_vow_image) }}" alt="Full Vow Image">
              @endif
            </div>
          </div>
        </div>
      ...
      <div class="form-group">
        ...
        <img
          ...
          src="{{ old('wedding_reception_image') ? asset('storage/' . old('wedding_reception_image')) : ($timeline->wedding_reception_image ? asset('storage/' . $timeline->wedding_reception_image) : '') }}"
          alt="Reception Image"
        >
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              @if($timeline->wedding_reception_image)
                <img src="{{ asset('storage/' . $timeline->wedding_reception_image) }}" alt="Full Reception Image">
              @endif
            </div>
          </div>
        </div>

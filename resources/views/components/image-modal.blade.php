        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    x-bind:style="'background-image: url({{ $baseUrl }}/' + $store.imageModal.item.image + ')'"
                </div>
                ...
                <div class="relative z-10 bg-opacity-80 flex flex-col">
                    ...
                    <div class="w-full h-2/3 overflow-hidden px-6">
                        <img
                            :src="'{{ $baseUrl }}/' + $store.imageModal.item.image"
                            :alt="`image-{$store.imageModal.item.title}`"
                            class="max-w-xs justify-self-center rounded-lg"
                        />
                        <h2 class="text-lg font-bold text-white pt-2" x-text="$store.imageModal.item.title"></h2>
                        <p class="text-sm text-[var(--spotify-white)] pb-4" x-text="$store.imageModal.item.description"></p>
                    </div>
                </div>
            </div>
        </div>

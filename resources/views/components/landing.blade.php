<div id="landingCard" class="landing-cover relative mx-auto justify-self-center w-full h-full">
    <div class="min-h-screen max-w-xl mx-auto justify-items-center">
        <div class="relative px-4 pt-4">
            <img src="https://slametandfatma.wedding/galeri/nikahfix.jpg" alt="Landing Image" class="w-80 h-auto mx-auto object-cover"/>

<div id="invitationPage" class="flex flex-col items-center justify-center w-full h-screen">
    ...
    <button id="LandingBtn" class="flex flex-col items-center justify-center justify-self-center hover:text-gray-300 py-4 px-4">
        <svg class="w-6 h-6 animate-bounce" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="m5 15 7-7 7 7"/>
        </svg>

                    ...
                    <div class="mt-3 flex flex-wrap items-center gap-2 sm:hidden">
                        @if (!$gift->qris_image)
                            <button
                                ...
                                class="text-gray-900 dark:text-gray-400 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 rounded-lg py-1.5 px-3 inline-flex items-center justify-center bg-white border-gray-200 border text-xs font-semibold"
                            >
                                <span id="{{ $defaultId }}">
                        ...
                        @if($gift->qris_image)
                            <button
                                ...
                                class="text-xs font-semibold flex items-center gap-1 rounded-lg py-1.5 px-3 bg-white border border-gray-200 hover:bg-gray-100 text-gray-900"

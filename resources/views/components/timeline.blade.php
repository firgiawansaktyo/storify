<div class="container-sweetvows bg-[var(--spotify-gray-bold)]">
    ...
    <div class="timeline pl-5 rounded-xl">      
        <ol class="relative border-s border-white">                  
            <li class="mb-10 ms-6 ml-8">            
                ...
                <img src="{{ Storage::disk(env('FILESYSTEM_DISK'))->url($wedding->wedding_vow_image) }}" alt="Lana Del Rey Born To Die" class="w-1/4 h-auto rounded-lg" />
            </li>
            <li class="ms-6 ml-8">            
                <span class="absolute flex items-center justify-center w-6 h-6 bg-[var(--spotify-gray-bold)] rounded-full -start-3 ring-8 ring-white">
                    <svg class="w-2.5 h-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <img src="{{ Storage::disk(env('FILESYSTEM_DISK'))->url($wedding->wedding_reception_image) }}" alt="Lana Del Rey Born To Die" class="w-1/4 h-auto rounded-lg" />
            </li>
        </ol>
    </div>
</div>

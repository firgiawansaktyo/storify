  ...
  <div class="podcast-header items-center">
    <div class="podcast-content flex flex-row align-center p-6 items-center justify-center gap-6">
      <img
        ...
        src="{{asset('podcasts/podcast.jpg')}}"
      ...
      <div class="podcast-text flex-1 gap-6">
        ...
        <h1 class="podcast-title text-sm sm:text-md md:text-lg lg:text-xl xl:text-2xl font-bold">Wedding: The Prologue to Our Happily Ever After</h1>
        <div class="podcast-subtitle text-sm sm:text-lg md:text-xl font-medium">Happy Ending</div>
      </div>
    </div>
  </div>
  <div class="podcast-duration max-w-3xl mx-auto px-6 pt-2.5 pb-2 bg-gradient-to-b from-[var(--spotify-gray-bold)]/40 to-[var(--spotify-gray-bold)]">
    <div class="flex flew-row items-center">
      <img 
        ...
        alt="Storify Logo" 
        class="w-6"/>
      <span class="px-1 text-sm text-[var(--spotify-gray)]">Made for you</span>
    ...
    <div>
      <span class="text-sm text-[var(--spotify-gray)]">Monday, 10 December 2025</span>
      <span class="text-sm text-[var(--spotify-gray)]">•</span>
      <span class="text-sm text-[var(--spotify-gray)]">5h</span>
    </div>

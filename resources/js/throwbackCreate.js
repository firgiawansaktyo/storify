document.addEventListener('DOMContentLoaded', () => {
    const metaEl = document.getElementById('throwback-create-data');
    if (!metaEl) return;
    ...
    saveButton.addEventListener('click', function () {
        ...
        axios.post(storeRoute, throwbackData)
            .then(function () {
                successBox.classList.remove('d-none');
                successBox.textContent = 'Throwback Image created successfully!';
                setTimeout(() => {
            ...
            .catch(function (error) {
                ...
                if (error.response && error.response.data && error.response.data.errors) {
                    ...
                    errorBox.textContent = 'Error creating throwback image.';
                }
            });
    });
});

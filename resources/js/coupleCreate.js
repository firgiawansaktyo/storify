document.addEventListener('DOMContentLoaded', () => {
    const metaEl = document.getElementById('couple-create-data');
    if (!metaEl) return;
    ...
    saveButton.addEventListener('click', function () {
        ...
        axios.post(storeRoute, coupleData)
            .then(function () {
                successBox.classList.remove('d-none');
                successBox.textContent = 'Couple created successfully!';
                setTimeout(() => {
            ...
            .catch(function (error) {
                ...
                if (error.response && error.response.data && error.response.data.errors) {
                    ...
                    errorBox.textContent = 'Error creating couple.';
                }
            });
    });
});
